...
app.layout = html.Div([
    html.Div([
        ...
        ],style={'display':'block','background-color':'rgba(71,75,80, 0.1)',"position": "fixed",'width':'100%','height':'10%','margin-left': '10%','top':0,'box-shadow': '0 4px 8px 0 rgba(0, 0, 0, 0.9), 0 6px 20px 0 rgba(0, 0, 0, 0.4)'}),
        html.Br(),
        html.Br(),
